...
export const loadUsersSuccess = createAction("[Users API] Users Loaded Success", props<{ payload: IUser[] }>());

export const loadUsersFailure = createAction("[Users API] Users Loaded Error", props<{ error: ApiError }>());
